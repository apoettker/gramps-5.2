...
from gramps.gen.lib import (ChildRefType, Date, Span, Name,
                            EventType, EventRoleType,
...
def find_records(db, filter, unpidset, top_size, callname,
    ...
    for person_handle in person_handle_list:
        ...
        for family_handle in person.get_family_handle_list():
            ...
            for event_ref in family.get_event_ref_list():
                ...
                elif (event.type.value == EventType.CUSTOM and \
                      event.type.string == 'Trauung') and \
    ...
    for family in db.iter_families():
        ...
        if _good_date(father_birth_date) and _good_date(mother_birth_date):
            if father_birth_date.match(mother_birth_date, comparison=">>"):
                a = 1
            elif mother_birth_date.match(father_birth_date, comparison=">>"):
                a = 1
            else:
                a = 1
